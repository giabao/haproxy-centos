...
src:
	...
	[ -f $(CURDIR)/tmp/SOURCES/haproxy-1.5-dev18.tar.gz ] || wget -O $(CURDIR)/tmp/SOURCES/haproxy-1.5-dev18.tar.gz http://haproxy.1wt.eu/download/1.5/src/devel/haproxy-1.5-dev18.tar.gz
